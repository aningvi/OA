...
<body>
	...
	<!--显示表单内容-->
	<div id=MainArea>
		<s:form action="user_%{id != null ? 'edit' : 'add'}">
				...
				<div class="ItemBlock">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						<tr>
							...
							<td>
								<s:select name="departmentId" list="#departmentList" cssClass="SelectStyle"  listKey="id" listValue="name" headerKey="" headerValue="===请选择部门==="></s:select>
							</td>
						</tr>
						<tr>
							<td>登录名</td>
			...
			<div class="ItemBlockBorder">
				<div class="ItemBlock">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						<tr>
							<td width="100">岗位</td>
							<td><s:select name="roleIds" list="#roleList" multiple="true" size="10"
								cssClass="SelectStyle" listKey="id" listValue="name"/>
								 按住Ctrl键可以多选或取消选择</td>
						</tr>
					</table>
				</div>
